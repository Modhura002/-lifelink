...
// Fetch real hospitals from our local API route (which queries Overpass securely)
async function fetchNearbyHospitals(lat: number, lng: number, radiusM = 10000): Promise<Hospital[]> {
  const res = await fetch(`/api/hospitals/nearby?lat=${lat}&lng=${lng}&radiusM=${radiusM}`);
